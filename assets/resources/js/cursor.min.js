! function(modules) {
    ...
    }, __webpack_require__.p = "/assets/js/", __webpack_require__(__webpack_require__.s = "./src/js/index.js")
}({
    "./node_modules/gsap/CSSPlugin.js":
        ...
        function(module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__), __webpack_require__.d(__webpack_exports__, "CSSPlugin", (function() {
                return CSSPlugin
            ...
            var _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__( /*! ./gsap-core.js */ "./node_modules/gsap/gsap-core.js"),
                define = !1,
                _win, _doc, _docElement, _pluginInitted, _tempDiv, _tempDivStyler, _recentSetterPlugin, _windowExists = function _windowExists() {
                ...
                _checkPropPrefix = function _checkPropPrefix(property, element, preferPrefix) {
                    var e, s = (element || _tempDiv).style,
                        i = 5;
                ...
                _initCore = function _initCore() {
                    _windowExists() && window.document && (_win = window, _doc = _win.document, _docElement = _doc.documentElement, _tempDiv = _createElement("div") || {
                        style: {}
                    }, _tempDivStyler = _createElement("div"), _transformProp = _checkPropPrefix(_transformProp), _transformOriginProp = _checkPropPrefix(_transformOriginProp), _tempDiv.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", _supports3D = !!_checkPropPrefix("perspective"), _pluginInitted = 1)
                },
                ...
                _removeProperty = function _removeProperty(target, property) {
                    if (property) {
                        ...
                        property in _transformProps && (property = _transformProp), style.removeProperty ? ("ms" !== property.substr(0, 2) && "webkit" !== property.substr(0, 6) || (property = "-" + property), style.removeProperty(property.replace(_capsExp, "-$1").toLowerCase())) : style.removeAttribute(property)
                    }
                },
                ...
                _convertToUnit = function _convertToUnit(target, property, value, unit) {
                    ...
                    return unit === curUnit || !curValue || _nonConvertibleUnits[unit] || _nonConvertibleUnits[curUnit] ? curValue : ("px" !== curUnit && !toPixels && (curValue = _convertToUnit(target, property, value, "px")), isSVG = target.getCTM && _isSVG(target), toPercent && (_transformProps[property] || ~property.indexOf("adius")) ? Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__._round)(curValue / (isSVG ? target.getBBox()[horizontal ? "width" : "height"] : target[measureProperty]) * 100) : (style[horizontal ? "width" : "height"] = 100 + (toPixels ? curUnit : unit), parent = ~property.indexOf("adius") || "em" === unit && target.appendChild && !isRootSVG ? target : target.parentNode, isSVG && (parent = (target.ownerSVGElement || {}).parentNode), parent && parent !== _doc && parent.appendChild || (parent = _doc.body), (cache = parent._gsap) && toPercent && cache.width && horizontal && cache.time === _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__._ticker.time ? Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__._round)(curValue / cache.width * 100) : ((toPercent || "%" === curUnit) && (style.position = _getComputedProperty(target, "position")), parent === target && (style.position = "static"), parent.appendChild(_tempDiv), px = _tempDiv[measureProperty], parent.removeChild(_tempDiv), style.position = "absolute", horizontal && toPercent && ((cache = Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__._getCache)(parent)).time = _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__._ticker.time, cache.width = parent[measureProperty]), Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__._round)(toPixels ? px * curValue / 100 : px && curValue ? 100 / px * curValue : 0))))
                },
                _get = function _get(target, property, unit, uncache) {
                    var value;
                    return _pluginInitted || _initCore(), property in _propertyAliases && "transform" !== property && ~(property = _propertyAliases[property]).indexOf(",") && (property = property.split(",")[0]), _transformProps[property] && "transform" !== property ? (value = _parseTransform(target, uncache), value = "transformOrigin" !== property ? value[property] : _firstTwoOnly(_getComputedProperty(target, _transformOriginProp)) + " " + value.zOrigin + "px") : (!(value = target.style[property]) || "auto" === value || uncache || ~(value + "").indexOf("calc(")) && (value = _specialProps[property] && _specialProps[property](target, property, unit) || _getComputedProperty(target, property) || Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__._getProperty)(target, property) || ("opacity" === property ? 1 : 0)), unit && !~(value + "").indexOf(" ") ? _convertToUnit(target, property, value, unit) + unit : value
                },
                _tweenComplexCSSString = function _tweenComplexCSSString(target, prop, start, end) {
                    if (!start || "none" === start) {
                        var p = _checkPropPrefix(prop, target, 1),
                            s = p && _getComputedProperty(target, p, 1);
                        s && s !== start && (prop = p, start = s)
                    }
                    ...
                    if (pt.b = start, pt.e = end, start += "", "auto" === (end += "") && (target.style[prop] = end, end = _getComputedProperty(target, prop) || end, target.style[prop] = start), a = [start, end], Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__._colorStringFilter)(a), end = a[1], startValues = (start = a[0]).match(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__._numWithUnitExp) || [], (endValues = end.match(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__._numWithUnitExp) || []).length) {
                        for (; result = _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__._numWithUnitExp.exec(end);) endValue = result[0], chunk = end.substring(index, result.index), color ? color = (color + 1) % 5 : "rgba(" !== chunk.substr(-5) && "hsla(" !== chunk.substr(-5) || (color = 1), endValue !== (startValue = startValues[matchIndex++] || "") && (startNum = parseFloat(startValue) || 0, startUnit = startValue.substr((startNum + "").length), (relative = "=" === endValue.charAt(1) ? +(endValue.charAt(0) + "1") : 0) && (endValue = endValue.substr(2)), endNum = parseFloat(endValue), endUnit = endValue.substr((endNum + "").length), index = _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__._numWithUnitExp.lastIndex - endUnit.length, endUnit || (endUnit = endUnit || _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__._config.units[prop] || startUnit, index === end.length && (end += endUnit, pt.e += endUnit)), startUnit !== endUnit && (startNum = _convertToUnit(target, prop, startValue, endUnit) || 0), pt._pt = {
                            _next: pt._pt,
                ...
                _renderClearProps = function _renderClearProps(ratio, data) {
                    if (data.tween && data.tween._time === data.tween._dur) {
                        ...
                        clearTransforms && (_removeProperty(target, _transformProp), cache && (cache.svg && target.removeAttribute("transform"), _parseTransform(target, 1), cache.uncache = 1))
                    }
                },
                _specialProps = {
                ...
                _addRawTransformPTs = function _addRawTransformPTs(plugin, transforms, target) {
                    ...
                    for (p in style.cssText = getComputedStyle(target).cssText + ";position:absolute;display:block;", style[_transformProp] = transforms, _doc.body.appendChild(_tempDivStyler), endCache = _parseTransform(_tempDivStyler, 1), _transformProps)(startValue = startCache[p]) !== (endValue = endCache[p]) && exclude.indexOf(p) < 0 && (startNum = (startUnit = Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__.getUnit)(startValue)) !== (endUnit = Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__.getUnit)(endValue)) ? _convertToUnit(target, p, startValue, endUnit) : parseFloat(startValue), endNum = parseFloat(endValue), plugin._pt = new _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__.PropTween(plugin._pt, startCache, p, startNum, endNum - startNum, _renderCSSProp), plugin._pt.u = endUnit || 0, plugin._props.push(p));
            ...
            var CSSPlugin = {
                    ...
                    init: function init(target, vars, tween, index, targets) {
                        ...
                        for (p in _pluginInitted || _initCore(), vars)
                            if ("autoRound" !== p && (endValue = vars[p], !_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__._plugins[p] || !Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__._checkPlugin)(p, vars, tween, index, target, targets)))
                                if (type = typeof endValue, specialProp = _specialProps[p], "function" === type && (type = typeof(endValue = endValue.call(tween, index, target, targets))), "string" === type && ~endValue.indexOf("random(") && (endValue = Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__._replaceRandom)(endValue)), specialProp) specialProp(this, target, p, endValue, tween) && (hasPriority = 1);
                                else if ("--" === p.substr(0, 2)) this.add(style, "setProperty", getComputedStyle(target).getPropertyValue(p) + "", endValue + "", index, targets, 0, 0, p);
                        else {
                            if (startValue = _get(target, p), startNum = parseFloat(startValue), (relative = "string" === type && "=" === endValue.charAt(1) ? +(endValue.charAt(0) + "1") : 0) && (endValue = endValue.substr(2)), endNum = parseFloat(endValue), p in _propertyAliases && ("autoAlpha" === p && (1 === startNum && "hidden" === _get(target, "visibility") && endNum && (startNum = 0), _addNonTweeningPT(this, style, "visibility", startNum ? "inherit" : "hidden", endNum ? "inherit" : "hidden", !endNum)), "scale" !== p && "transform" !== p && ~(p = _propertyAliases[p]).indexOf(",") && (p = p.split(",")[0])), isTransformRelated = p in _transformProps)
                                if (transformPropTween || ((cache = target._gsap).renderTransform || _parseTransform(target), smooth = !1 !== vars.smoothOrigin && cache.smooth, (transformPropTween = this._pt = new _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__.PropTween(this._pt, style, _transformProp, 0, 1, cache.renderTransform, cache, 0, -1)).dep = 1), "scale" === p) this._pt = new _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__.PropTween(this._pt, cache, "scaleY", cache.scaleY, relative ? relative * endNum : endNum - cache.scaleY), props.push("scaleY", p), p += "X";
                                else {
                                    if ("transformOrigin" === p) {
                                        endValue = _convertKeywordsToPercentages(endValue), cache.svg ? _applySVGOrigin(target, endValue, 0, smooth, 0, this) : ((endUnit = parseFloat(endValue.split(" ")[2]) || 0) !== cache.zOrigin && _addNonTweeningPT(this, cache, "zOrigin", cache.zOrigin, endUnit), _addNonTweeningPT(this, style, p, _firstTwoOnly(startValue), _firstTwoOnly(endValue)));
                                        continue
                                    }
                                    if ("svgOrigin" === p) {
                            ...
                            if (isTransformRelated || (endNum || 0 === endNum) && (startNum || 0 === startNum) && !_complexExp.test(endValue) && p in style) endNum || (endNum = 0), (startUnit = (startValue + "").substr((startNum + "").length)) !== (endUnit = (endValue + "").substr((endNum + "").length) || (p in _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__._config.units ? _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__._config.units[p] : startUnit)) && (startNum = _convertToUnit(target, p, startValue, endUnit)), this._pt = new _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__.PropTween(this._pt, isTransformRelated ? cache : style, p, startNum, relative ? relative * endNum : endNum - startNum, "px" !== endUnit || !1 === vars.autoRound || isTransformRelated ? _renderCSSProp : _renderRoundedCSSProp), this._pt.u = endUnit || 0, startUnit !== endUnit && (this._pt.b = startValue, this._pt.r = _renderCSSPropWithBeginning);
                            else if (p in style) _tweenComplexCSSString.call(this, target, p, startValue, endValue);
                            else {
                                if (!(p in target)) {
                ...
                positionAndScale, rotation, others, aliases, all;
            _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__.gsap.utils.checkPrefix = _checkPropPrefix, positionAndScale = "x,y,z,scale,scaleX,scaleY,xPercent,yPercent", rotation = "rotation,rotationX,rotationY,skewX,skewY", others = "transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective", aliases = "0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY", all = Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__._forEachName)(positionAndScale + "," + rotation + "," + others, (function(name) {
                _transformProps[name] = 1
            })), Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__._forEachName)(rotation, (function(name) {
                _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__._config.units[name] = "deg", _rotationalProperties[name] = 1
            })), _propertyAliases[all[13]] = positionAndScale + "," + rotation, Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__._forEachName)(aliases, (function(name) {
    ...
    "./node_modules/gsap/gsap-core.js":
        ...
        function(module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__), __webpack_require__.d(__webpack_exports__, "GSCache", (function() {
                return GSCache
            ...
            var _config = {
                ...
                _parseVars = function _parseVars(params, type, parent) {
                    var isLegacy = _isNumber(params[1]),
                        ...
                        irVars;
                    if (isLegacy && (vars.duration = params[1]), vars.parent = parent, type) {
                        for (irVars = vars; parent && !("immediateRender" in irVars);) irVars = parent.vars.defaults || {}, parent = _isNotFalse(parent.vars.inherit) && parent.parent;
                ...
                _lazySafeRender = function _lazySafeRender(animation, time, suppressEvents, force) {
                    _lazyTweens.length && _lazyRender(), animation.render(time, suppressEvents, force), _lazyTweens.length && _lazyRender()
                },
                _numericIfPossible = function _numericIfPossible(value) {
                    var n = parseFloat(value);
                    return (n || 0 === n) && (value + "").match(_delimitedValueExp).length < 2 ? n : value
                },
                ...
                _setKeyframeDefaults = function _setKeyframeDefaults(obj, defaults) {
                    for (var p in defaults) p in obj || "duration" === p || "ease" === p || (obj[p] = defaults[p])
                },
                ...
                _removeFromParent = function _removeFromParent(child, onlyIfParentHasAutoRemove) {
                    !child.parent || onlyIfParentHasAutoRemove && !child.parent.autoRemoveChildren || child.parent.remove(child), child._act = 0
                },
                ...
                _setEnd = function _setEnd(animation) {
                    return animation._end = _round(animation._start + (animation._tDur / Math.abs(animation._ts || animation._rts || 1e-8) || 0))
                },
                _postAddChecks = function _postAddChecks(timeline, child) {
                    var t;
                    if ((child._time || child._initted && !child._dur) && (t = _parentToChildTotalTime(timeline.rawTime(), child), (!child._dur || _clamp(0, child.totalDuration(), t) - child._tTime > 1e-8) && child.render(t, !0)), _uncache(timeline)._dp && timeline._initted && timeline._time >= timeline._dur && timeline._ts) {
                ...
                _addToTimeline = function _addToTimeline(timeline, child, position, skipChecks) {
                    return child.parent && _removeFromParent(child), child._start = _round(position + child._delay), child._end = _round(child._start + (child.totalDuration() / Math.abs(child.timeScale()) || 0)), _addLinkedListItem(timeline, child, "_first", "_last", timeline._sort ? "_start" : 0), timeline._recent = child, skipChecks || _postAddChecks(timeline, child), timeline
                },
                _scrollTrigger = function _scrollTrigger(animation, trigger) {
                    return (_globals.ScrollTrigger || _missingPlugin("scrollTrigger", trigger)) && _globals.ScrollTrigger.create(trigger, animation)
                },
                _attemptInitTween = function _attemptInitTween(tween, totalTime, force, suppressEvents) {
                    return _initTween(tween, totalTime), tween._initted ? !force && tween._pt && (tween._dur && !1 !== tween.vars.lazy || !tween._dur && tween.vars.lazy) && _lastRenderedFrame !== _ticker.frame ? (_lazyTweens.push(tween), tween._lazy = [totalTime, suppressEvents], 1) : void 0 : 1
                },
                _renderZeroDurationTween = function _renderZeroDurationTween(tween, totalTime, suppressEvents, force) {
                    var prevRatio = tween.ratio,
                        ratio = totalTime < 0 || !totalTime && prevRatio && !tween._start && tween._zTime > 1e-8 && !tween._dp._lock || tween._ts < 0 || tween._dp._ts < 0 ? 0 : 1,
                        repeatDelay = tween._rDelay,
                        tTime = 0,
                        pt, iteration, prevIteration;
                    if (repeatDelay && tween._repeat && (tTime = _clamp(0, tween._tDur, totalTime), (iteration = _animationCycle(tTime, repeatDelay)) !== (prevIteration = _animationCycle(tween._tTime, repeatDelay)) && (prevRatio = 1 - ratio, tween.vars.repeatRefresh && tween._initted && tween.invalidate())), tween._initted || !_attemptInitTween(tween, totalTime, force, suppressEvents))
                        if (ratio !== prevRatio || force || 1e-8 === tween._zTime || !totalTime && tween._zTime) {
                            for (prevIteration = tween._zTime, tween._zTime = totalTime || (suppressEvents ? 1e-8 : 0), suppressEvents || (suppressEvents = totalTime && !prevIteration), tween.ratio = ratio, tween._from && (ratio = 1 - ratio), tween._time = 0, tween._tTime = tTime, suppressEvents || _callback(tween, "onStart"), pt = tween._pt; pt;) pt.r(ratio, pt.d), pt = pt._next;
                            tween._startAt && totalTime < 0 && tween._startAt.render(totalTime, !0, !0), tween._onUpdate && !suppressEvents && _callback(tween, "onUpdate"), tTime && tween._repeat && !suppressEvents && tween.parent && _callback(tween, "onRepeat"), (totalTime >= tween._tDur || totalTime < 0) && tween.ratio === ratio && (ratio && _removeFromParent(tween, 1), suppressEvents || (_callback(tween, ratio ? "onComplete" : "onReverseComplete", !0), tween._prom && tween._prom()))
                ...
                _findNextPauseTween = function _findNextPauseTween(animation, prevTime, time) {
                    ...
                    if (time > prevTime)
                        for (child = animation._first; child && child._start <= time;) {
                            if (!child._dur && "isPause" === child.data && child._start > prevTime) return child;
                            child = child._next
                        } else
                ...
                _setDuration = function _setDuration(animation, duration, skipUncache) {
                    ...
                    return animation._dur = dur, animation._tDur = repeat ? repeat < 0 ? 1e10 : _round(dur * (repeat + 1) + animation._rDelay * repeat) : dur, animation._time > dur && (animation._time = dur, animation._tTime = Math.min(animation._tTime, animation._tDur)), !skipUncache && _uncache(animation.parent), animation.parent && _setEnd(animation), animation
                },
                ...
                _parsePosition = function _parsePosition(animation, position) {
                    var labels = animation.labels,
                        ...
                        clippedDuration = animation.duration() >= 1e8 ? recent.endTime(!1) : animation._dur,
                        i, offset;
                    return _isString(position) && (isNaN(position) || position in labels) ? "<" === (i = position.charAt(0)) || ">" === i ? ("<" === i ? recent._start : recent.endTime(recent._repeat >= 0)) + (parseFloat(position.substr(1)) || 0) : (i = position.indexOf("=")) < 0 ? (position in labels || (labels[position] = clippedDuration), labels[position]) : (offset = +(position.charAt(i - 1) + position.substr(i + 1)), i > 1 ? _parsePosition(animation, position.substr(0, i - 1)) + offset : clippedDuration + offset) : null == position ? clippedDuration : +position
                },
                ...
                toArray = function toArray(value, leaveStrings) {
                    return !_isString(value) || leaveStrings || !_coreInitted && _wake() ? _isArray(value) ? _flatten(value, leaveStrings) : _isArrayLike(value) ? _slice.call(value, 0) : value ? [value] : [] : _slice.call(_doc.querySelectorAll(value), 0)
                },
                ...
                distribute = function distribute(v) {
                    ...
                    return _isString(from) ? ratioX = ratioY = {
                        ...
                        function(i, target, a) {
                            ...
                            if (!distances) {
                                if (!(wrapAt = "auto" === vars.grid ? 0 : (vars.grid || [1, 1e8])[1])) {
                                    for (max = -1e8; max < (max = a[wrapAt++].getBoundingClientRect().left) && wrapAt < l;);
                                    wrapAt--
                                }
                                for (distances = cache[l] = [], originX = ratios ? Math.min(wrapAt, l) * ratioX - .5 : from % wrapAt, originY = ratios ? l * ratioY / wrapAt - .5 : from / wrapAt | 0, max = 0, min = 1e8, j = 0; j < l; j++) x = j % wrapAt - originX, y = originY - (j / wrapAt | 0), distances[j] = d = axis ? Math.abs("y" === axis ? y : x) : _sqrt(x * x + y * y), d > max && (max = d), d < min && (min = d);
                            ...
                            return l = (distances[i] - distances.min) / distances.max || 0, _round(distances.b + (ease ? ease(l) : l) * distances.v) + distances.u
                        }
                },
                ...
                snap = function snap(snapTo, value) {
                    var isArray = _isArray(snapTo),
                        radius, is2D;
                    return !isArray && _isObject(snapTo) && (radius = isArray = snapTo.radius || 1e8, snapTo.values ? (snapTo = toArray(snapTo.values), (is2D = !_isNumber(snapTo[0])) && (radius *= radius)) : snapTo = _roundModifier(snapTo.increment)), _conditionalReturn(value, isArray ? _isFunction(snapTo) ? function(raw) {
                        return is2D = snapTo(raw), Math.abs(is2D - raw) <= radius ? is2D : raw
                    } : function(raw) {
                        for (var x = parseFloat(is2D ? raw.x : raw), y = parseFloat(is2D ? raw.y : 0), min = 1e8, closest = 0, i = snapTo.length, dx, dy; i--;)(dx = is2D ? (dx = snapTo[i].x - x) * dx + (dy = snapTo[i].y - y) * dy : Math.abs(snapTo[i] - x)) < min && (min = dx, closest = i);
                ...
                _replaceRandom = function _replaceRandom(value) {
                    for (var prev = 0, s = "", i, nums, end, isArray; ~(i = value.indexOf("random(", prev));) end = value.indexOf(")", i), isArray = "[" === value.charAt(i + 7), nums = value.substr(i + 7, end - i - 7).match(isArray ? _delimitedValueExp : _strictNumExp), s += value.substr(prev, i - prev) + random(isArray ? nums : +nums[0], +nums[1], +nums[2] || 1e-5), prev = end + 1;
                ...
                _callback = function _callback(animation, type, executeLazyFirst) {
                    var v = animation.vars,
                        callback = v[type],
                        params, scope;
                    if (callback) return params = v[type + "Params"], scope = v.callbackScope || animation, executeLazyFirst && _lazyTweens.length && _lazyRender(), params ? callback.apply(scope, params) : callback.call(scope)
                },
                _interrupt = function _interrupt(animation) {
                    return _removeFromParent(animation), animation.progress() < 1 && _callback(animation, "onInterrupt"), animation
                },
                ...
                splitColor = function splitColor(v, toHSL, forceAlpha) {
                    var a = v ? _isNumber(v) ? [v >> 16, v >> 8 & 255, 255 & v] : 0 : _colorLookup.black,
                ...
                _tickerActive, _ticker = (_getTime = Date.now, _lagThreshold = 500, _adjustedLag = 33, _startTime = _getTime(), _lastUpdate = _startTime, _nextTime = _gap = 1 / 240, _tick = function _tick(v) {
                    var elapsed = _getTime() - _lastUpdate,
                        manual = !0 === v,
                        overlap, dispatch;
                    elapsed > _lagThreshold && (_startTime += elapsed - _adjustedLag), _lastUpdate += elapsed, _self.time = (_lastUpdate - _startTime) / 1e3, ((overlap = _self.time - _nextTime) > 0 || manual) && (_self.frame++, _nextTime += overlap + (overlap >= _gap ? .004 : _gap - overlap), dispatch = 1), manual || (_id = _req(_tick)), dispatch && _listeners.forEach((function(l) {
                    ...
                    wake: function wake() {
                        _coreReady && (!_coreInitted && _windowExists() && (_win = _coreInitted = window, _doc = _win.document || {}, _globals.gsap = gsap, (_win.gsapVersions || (_win.gsapVersions = [])).push(gsap.version), _install(_installScope || _win.GreenSockGlobals || !_win.gsap && _win || {}), _raf = _win.requestAnimationFrame), _id && _self.sleep(), _req = _raf || function(f) {
                    ...
                    lagSmoothing: function lagSmoothing(threshold, adjustedLag) {
                        _lagThreshold = threshold || 1e8, _adjustedLag = Math.min(adjustedLag, _lagThreshold, 0)
                    },
                    fps: function fps(_fps) {
                        _gap = 1 / (_fps || 240), _nextTime = _self.time + _gap
                    },
                    add: function add(callback) {
                        _listeners.indexOf(callback) < 0 && _listeners.push(callback), _wake()
                    },
                ...
                _parseObjectInString = function _parseObjectInString(value) {
                    for (var obj = {}, split = value.substr(1, value.length - 3).split(":"), key = split[0], i = 1, l = split.length, index, val, parsedVal; i < l; i++) val = split[i], index = i !== l - 1 ? val.lastIndexOf(",") : val.length, parsedVal = val.substr(0, index), obj[key] = isNaN(parsedVal) ? parsedVal.replace(_quotesExp, "").trim() : +parsedVal, key = val.substr(index + 1).trim();
                    return obj
                },
                ...
                _propagateYoyoEase = function _propagateYoyoEase(timeline, isYoyo) {
                    for (var child = timeline._first, ease; child;) child instanceof Timeline ? _propagateYoyoEase(child, isYoyo) : !child.vars.yoyoEase || child._yoyo && child._repeat || child._yoyo === isYoyo || (child.timeline ? _propagateYoyoEase(child.timeline, isYoyo) : (ease = child._ease, child._ease = child._yEase, child._yEase = ease, child._yoyo = isYoyo)), child = child._next
                },
                ...
                _getTime, _lagThreshold, _adjustedLag, _startTime, _lastUpdate, _gap, _nextTime, _listeners, _id, _req, _raf, _self, _tick, n, c, n1, n2, n3, easeOut;
            ...
            })), _easeMap.Linear.easeNone = _easeMap.none = _easeMap.Linear.easeIn, _insertEase("Elastic", _configElastic("in"), _configElastic("out"), _configElastic()), n = 7.5625, n2 = 2 * (n1 = 1 / (c = 2.75)), n3 = 2.5 * n1, _insertEase("Bounce", (function(p) {
                return 1 - easeOut(1 - p)
            }), easeOut = function easeOut(p) {
            ...
            var GSCache = function GSCache(target, harness) {
                ...
                Animation = function() {
                    function Animation(vars, time) {
                        var parent = vars.parent || _globalTimeline;
                        this.vars = vars, this._delay = +vars.delay || 0, (this._repeat = vars.repeat || 0) && (this._rDelay = vars.repeatDelay || 0, this._yoyo = !!vars.yoyo || !!vars.yoyoEase), this._ts = 1, _setDuration(this, +vars.duration, 1), this.data = vars.data, _tickerActive || _ticker.wake(), parent && _addToTimeline(parent, this, time || 0 === time ? time : parent._time, 1), vars.reversed && this.reverse(), vars.paused && this.paused(!0)
                    }
                    ...
                    return _proto.delay = function delay(value) {
                        ...
                        if (parent && parent.smoothChildTiming && this._ts) {
                            for (this._start = _round(parent._time - (this._ts > 0 ? _totalTime / this._ts : ((this._dirty ? this.totalDuration() : this._tDur) - _totalTime) / -this._ts)), _setEnd(this), parent._dirty || _uncache(parent); parent.parent;) parent.parent._time !== parent._start + (parent._ts >= 0 ? parent._tTime / parent._ts : (parent.totalDuration() - parent._tTime) / -parent._ts) && parent.totalTime(parent._tTime, !0), parent = parent.parent;
                        ...
                        return (this._tTime !== _totalTime || !this._dur && !suppressEvents || this._initted && 1e-8 === Math.abs(this._zTime) || !_totalTime && !this._initted) && (this._ts || (this._pTime = _totalTime), _lazySafeRender(this, _totalTime, suppressEvents)), this
                        ...
                        return this._rts = +value || 0, this._ts = this._ps || -1e-8 === value ? 0 : this._rts, _recacheAncestors(this.totalTime(_clamp(0, this._tDur, tTime), !0))
                    }, _proto.paused = function paused(value) {
                        return arguments.length ? (this._ps !== value && (this._ps = value, value ? (this._pTime = this._tTime || Math.max(-this._delay, this.rawTime()), this._ts = this._act = 0) : (_wake(), this._ts = this._rts, this.totalTime(this.parent && !this.parent.smoothChildTiming ? this.rawTime() : this._tTime || this._pTime, 1 === this.progress() && (this._tTime -= 1e-8) && 1e-8 !== Math.abs(this._zTime)))), this) : this._ps
                        ...
                        return arguments.length ? (this._repeat = value, _onUpdateTotalDuration(this)) : this._repeat
                    }, _proto.repeatDelay = function repeatDelay(value) {
                        return arguments.length ? (this._rDelay = value, _onUpdateTotalDuration(this)) : this._rDelay
                        ...
                        var parent = this.parent || this._dp,
                            start = this._start,
                            rawTime;
                        return !(parent && !(this._ts && (this._initted || !hasStarted) && parent.isActive(hasStarted) && (rawTime = parent.rawTime(!0)) >= start && rawTime < this.endTime(!0) - 1e-8))
            ...
            var Timeline = function(_Animation) {
                function Timeline(vars, time) {
                    var _this;
                    return void 0 === vars && (vars = {}), (_this = _Animation.call(this, vars, time) || this).labels = {}, _this.smoothChildTiming = !!vars.smoothChildTiming, _this.autoRemoveChildren = !!vars.autoRemoveChildren, _this._sort = _isNotFalse(vars.sortChildren), _this.parent && _postAddChecks(_this.parent, _assertThisInitialized(_this)), vars.scrollTrigger && _scrollTrigger(_assertThisInitialized(_this), vars.scrollTrigger), _this
                }
                _inheritsLoose(Timeline, _Animation);
                var _proto2 = Timeline.prototype;
                return _proto2.to = function to(targets, vars, position) {
                    return new Tween(targets, _parseVars(arguments, 0, this), _parsePosition(this, _isNumber(vars) ? arguments[3] : position)), this
                }, _proto2.from = function from(targets, vars, position) {
                    return new Tween(targets, _parseVars(arguments, 1, this), _parsePosition(this, _isNumber(vars) ? arguments[3] : position)), this
                }, _proto2.fromTo = function fromTo(targets, fromVars, toVars, position) {
                    return new Tween(targets, _parseVars(arguments, 2, this), _parsePosition(this, _isNumber(fromVars) ? arguments[4] : position)), this
                    ...
                    var prevTime = this._time,
                        ...
                        dur = this._dur,
                        tTime = this !== _globalTimeline && totalTime > tDur - 1e-8 && totalTime >= 0 ? tDur : totalTime < 1e-8 ? 0 : totalTime,
                        crossingStart = this._zTime < 0 != totalTime < 0 && (this._initted || !dur),
                        time, child, next, iteration, cycleDuration, prevPaused, pauseTween, timeScale, prevStart, prevIteration, yoyo, isYoyo;
                    if (tTime !== this._tTime || force || crossingStart) {
                        if (prevTime !== this._time && dur && (tTime += this._time - prevTime, totalTime += this._time - prevTime), time = tTime, prevStart = this._start, prevPaused = !(timeScale = this._ts), crossingStart && (dur || (prevTime = this._zTime), (totalTime || !suppressEvents) && (this._zTime = totalTime)), this._repeat && (yoyo = this._yoyo, cycleDuration = dur + this._rDelay, ((time = _round(tTime % cycleDuration)) > dur || tDur === tTime) && (time = dur), (iteration = ~~(tTime / cycleDuration)) && iteration === tTime / cycleDuration && (time = dur, iteration--), prevIteration = _animationCycle(this._tTime, cycleDuration), !prevTime && this._tTime && prevIteration !== iteration && (prevIteration = iteration), yoyo && 1 & iteration && (time = dur - time, isYoyo = 1), iteration !== prevIteration && !this._lock)) {
                            var rewinding = yoyo && 1 & prevIteration,
                                doesWrap = rewinding === (yoyo && 1 & iteration);
                            if (iteration < prevIteration && (rewinding = !rewinding), prevTime = rewinding ? 0 : dur, this._lock = 1, this.render(prevTime || (isYoyo ? 0 : _round(iteration * cycleDuration)), suppressEvents, !dur)._lock = 0, !suppressEvents && this.parent && _callback(this, "onRepeat"), this.vars.repeatRefresh && !isYoyo && (this.invalidate()._lock = 1), prevTime !== this._time || prevPaused !== !this._ts) return this;
                            if (doesWrap && (this._lock = 2, prevTime = rewinding ? dur + 1e-4 : -1e-4, this.render(prevTime, !0), this.vars.repeatRefresh && !isYoyo && this.invalidate()), this._lock = 0, !this._ts && !prevPaused) return this;
                            _propagateYoyoEase(this, isYoyo)
                        }
                        if (this._hasPause && !this._forcing && this._lock < 2 && (pauseTween = _findNextPauseTween(this, _round(prevTime), _round(time))) && (tTime -= time - (time = pauseTween._start)), this._tTime = tTime, this._time = time, this._act = !timeScale, this._initted || (this._onUpdate = this.vars.onUpdate, this._initted = 1, this._zTime = totalTime), prevTime || !time || suppressEvents || _callback(this, "onStart"), time >= prevTime && totalTime >= 0)
                            for (child = this._first; child;) {
                                ...
                                for (var adjustedTime = totalTime < 0 ? totalTime : time; child;) {
                                    if (next = child._prev, (child._act || adjustedTime <= child._end) && child._ts && pauseTween !== child) {
                                        if (child.parent !== this) return this.render(totalTime, suppressEvents, force);
                                        if (child.render(child._ts > 0 ? (adjustedTime - child._start) * child._ts : (child._dirty ? child.totalDuration() : child._tDur) + (adjustedTime - child._start) * child._ts, suppressEvents, force), time !== this._time || !this._ts && !prevPaused) {
                    ...
                    void 0 === nested && (nested = !0), void 0 === tweens && (tweens = !0), void 0 === timelines && (timelines = !0), void 0 === ignoreBeforeTime && (ignoreBeforeTime = -1e8);
                    ...
                    return arguments.length ? (this._forcing = 1, this.parent || this._dp || !this._ts || (this._start = _round(_ticker.time - (this._ts > 0 ? _totalTime2 / this._ts : (this.totalDuration() - _totalTime2) / -this._ts))), _Animation.prototype.totalTime.call(this, _totalTime2, suppressEvents), this._forcing = 0, this) : this._tTime
                    ...
                    for (var a = [], parsedTargets = toArray(targets), child = this._first, children; child;) child instanceof Tween ? !_arrayContainsAny(child._targets, parsedTargets) || onlyActive && !child.isActive("started" === onlyActive) || a.push(child) : (children = child.getTweensOf(parsedTargets, onlyActive)).length && a.push.apply(a, children), child = child._next;
                    return a
                    ...
                    var tl = this,
                        ...
                        tween = Tween.to(tl, _setDefaults(vars, {
                            ...
                            onStart: function onStart() {
                                ...
                                tween._dur !== duration && _setDuration(tween, duration).render(tween._time, !0, !0), _onStart && _onStart.apply(tween, onStartParams || [])
                            }
                        }));
                    return tween
                    ...
                    for (var child = this._first, labels = this.labels, p; child;) child._start >= ignoreBeforeTime && (child._start += amount), child = child._next;
                    if (adjustLabels)
                        for (p in labels) labels[p] >= ignoreBeforeTime && (labels[p] += amount);
                    return _uncache(this)
                }, _proto2.invalidate = function invalidate() {
                    var child = this._first;
                    for (this._lock = 0; child;) child.invalidate(), child = child._next;
                    return _Animation.prototype.invalidate.call(this)
                }, _proto2.clear = function clear(includeLabels) {
                    void 0 === includeLabels && (includeLabels = !0);
                    for (var child = this._first, next; child;) next = child._next, this.remove(child), child = next;
                    return this._time = this._tTime = this._pTime = 0, includeLabels && (this.labels = {}), _uncache(this)
                    ...
                    if (self._dirty) {
                        for (parent = self.parent; child;) prev = child._prev, child._dirty && child.totalDuration(), (start = child._start) > prevStart && self._sort && child._ts && !self._lock ? (self._lock = 1, _addToTimeline(self, child, start - child._delay, 1)._lock = 0) : prevStart = start, start < 0 && child._ts && (max -= start, (!parent && !self._dp || parent && parent.smoothChildTiming) && (self._start += start / self._ts, self._time -= start, self._tTime -= start), self.shiftChildren(-start, !1, -Infinity), prevStart = 0), (end = _setEnd(child)) > max && child._ts && (max = end), child = prev;
            ...
            var _addComplexStringPropTween = function _addComplexStringPropTween(target, prop, start, end, setter, stringFilter, funcParam) {
                ...
                _processVars = function _processVars(vars, index, target, targets, tween) {
                    if (_isFunction(vars) && (vars = _parseFuncOrString(vars, tween, index, target, targets)), !_isObject(vars) || vars.style && vars.nodeType || _isArray(vars)) return _isString(vars) ? _parseFuncOrString(vars, tween, index, target, targets) : vars;
                    var copy = {},
                        p;
                ...
                _checkPlugin = function _checkPlugin(property, vars, tween, index, target, targets) {
                    ...
                    if (_plugins[property] && !1 !== (plugin = new _plugins[property]).init(target, plugin.rawVars ? vars[property] : _processVars(vars[property], index, target, targets, tween), tween, index, targets) && (tween._pt = pt = new PropTween(tween._pt, target, property, 0, 1, plugin.render, plugin, 0, plugin.priority), tween !== _quickTween))
                ...
                _overwritingTween, _initTween = function _initTween(tween, time) {
                    var vars = tween.vars,
                        ...
                        parent = tween.parent,
                        fullTargets = parent && "nested" === parent.data ? parent.parent._targets : targets,
                        autoOverwrite = "auto" === tween._overwrite,
                        tl = tween.timeline,
                        cleanVars, i, p, pt, target, hasPriority, gsData, harness, plugin, ptLookup, index, harnessVars;
                    if (tl && (!keyframes || !ease) && (ease = "none"), tween._ease = _parseEase(ease, _defaults.ease), tween._yEase = yoyoEase ? _invertEase(_parseEase(!0 === yoyoEase ? ease : yoyoEase, _defaults.ease)) : 0, yoyoEase && tween._yoyo && !tween._repeat && (yoyoEase = tween._yEase, tween._yEase = tween._ease, tween._ease = yoyoEase), !tl) {
                        if (harnessVars = (harness = targets[0] ? _getCache(targets[0]).harness : 0) && vars[harness.prop], cleanVars = _copyExcluding(vars, _reservedProps), prevStartAt && prevStartAt.render(-1, !0).kill(), startAt) {
                            ...
                            if (prevStartAt) !autoRevert && (tween._startAt = 0);
                                ...
                                stagger: 0,
                                parent: parent
                            }, cleanVars), harnessVars && (p[harness.prop] = harnessVars), _removeFromParent(tween._startAt = Tween.set(targets, p)), immediateRender) {
                            if (!time) return
                        } else _initTween(tween._startAt, 1e-8);
                        for (tween._pt = 0, lazy = dur && _isNotFalse(lazy) || lazy && !dur, i = 0; i < targets.length; i++) {
                            if (gsData = (target = targets[i])._gsap || _harness(targets)[i]._gsap, tween._ptLookup[i] = ptLookup = {}, _lazyLookup[gsData.id] && _lazyRender(), index = fullTargets === targets ? i : fullTargets.indexOf(target), harness && !1 !== (plugin = new harness).init(target, harnessVars || cleanVars, tween, index, fullTargets) && (tween._pt = pt = new PropTween(tween._pt, target, plugin.name, 0, 1, plugin.render, plugin, 0, plugin.priority), plugin._props.forEach((function(name) {
                                    ptLookup[name] = pt
                            ...
                            tween._op && tween._op[i] && tween.kill(target, tween._op[i]), autoOverwrite && tween._pt && (_overwritingTween = tween, _globalTimeline.killTweensOf(target, ptLookup, "started"), _overwritingTween = 0), tween._pt && lazy && (_lazyLookup[gsData.id] = 1)
                        }
                        hasPriority && _sortPropTweensByPriority(tween), tween._onInit && tween._onInit(tween)
                    }
                    tween._from = !tl && !!vars.runBackwards, tween._onUpdate = onUpdate, tween._initted = !!tween.parent
                },
                ...
                Tween = function(_Animation2) {
                    function Tween(targets, vars, time, skipInherit) {
                        var _this3;
                        "number" == typeof vars && (time.duration = vars, vars = time, time = null);
                        var _this3$vars = (_this3 = _Animation2.call(this, skipInherit ? vars : _inheritDefaults(vars), time) || this).vars,
                        ...
                        if (_this3._targets = parsedTargets.length ? _harness(parsedTargets) : _warn("GSAP target " + targets + " not found. https://greensock.com", !_config.nullTargetWarn) || [], _this3._ptLookup = [], _this3._overwrite = overwrite, keyframes || stagger || _isFuncOrString(duration) || _isFuncOrString(delay)) {
                            if (vars = _this3.vars, (tl = _this3.timeline = new Timeline({
                                    data: "nested",
                                    defaults: defaults || {}
                                })).kill(), tl.parent = _assertThisInitialized(_this3), keyframes) _setDefaults(tl.vars.defaults, {
                                ease: "none"
                            }), keyframes.forEach((function(frame) {
                                return tl.to(parsedTargets, frame, ">")
                            }));
                            else {
                                if (l = parsedTargets.length, staggerFunc = stagger ? distribute(stagger) : _emptyFunc, _isObject(stagger))
                                    for (p in stagger) ~_staggerTweenProps.indexOf(p) && (staggerVarsToMerge || (staggerVarsToMerge = {}), staggerVarsToMerge[p] = stagger[p]);
                                for (i = 0; i < l; i++) {
                                    for (p in copy = {}, vars) _staggerPropsToSkip.indexOf(p) < 0 && (copy[p] = vars[p]);
                                    copy.stagger = 0, yoyoEase && (copy.yoyoEase = yoyoEase), staggerVarsToMerge && _merge(copy, staggerVarsToMerge), curTarget = parsedTargets[i], copy.duration = +_parseFuncOrString(duration, _assertThisInitialized(_this3), i, curTarget, parsedTargets), copy.delay = (+_parseFuncOrString(delay, _assertThisInitialized(_this3), i, curTarget, parsedTargets) || 0) - _this3._delay, !stagger && 1 === l && copy.delay && (_this3._delay = delay = copy.delay, _this3._start += delay, copy.delay = 0), tl.to(curTarget, copy, staggerFunc(i, curTarget, parsedTargets))
                                }
                                tl.duration() ? duration = delay = 0 : _this3.timeline = 0
                            }
                            duration || _this3.duration(duration = tl.duration())
                        } else _this3.timeline = 0;
                        return !0 === overwrite && (_overwritingTween = _assertThisInitialized(_this3), _globalTimeline.killTweensOf(parsedTargets), _overwritingTween = 0), parent && _postAddChecks(parent, _assertThisInitialized(_this3)), (immediateRender || !duration && !keyframes && _this3._start === _round(parent._time) && _isNotFalse(immediateRender) && _hasNoPausedAncestors(_assertThisInitialized(_this3)) && "nested" !== parent.data) && (_this3._tTime = -1e-8, _this3.render(Math.max(0, -delay))), scrollTrigger && _scrollTrigger(_assertThisInitialized(_this3), scrollTrigger), _this3
                    }
                    ...
                    return _proto3.render = function render(totalTime, suppressEvents, force) {
                        var prevTime = this._time,
                            tDur = this._tDur,
                            dur = this._dur,
                            tTime = totalTime > tDur - 1e-8 && totalTime >= 0 ? tDur : totalTime < 1e-8 ? 0 : totalTime,
                            time, pt, iteration, cycleDuration, prevIteration, isYoyo, ratio, timeline, yoyoEase;
                        if (dur) {
                            if (tTime !== this._tTime || !totalTime || force || this._startAt && this._zTime < 0 != totalTime < 0) {
                                if (time = tTime, timeline = this.timeline, this._repeat) {
                                    if (cycleDuration = dur + this._rDelay, ((time = _round(tTime % cycleDuration)) > dur || tDur === tTime) && (time = dur), (iteration = ~~(tTime / cycleDuration)) && iteration === tTime / cycleDuration && (time = dur, iteration--), (isYoyo = this._yoyo && 1 & iteration) && (yoyoEase = this._yEase, time = dur - time), prevIteration = _animationCycle(this._tTime, cycleDuration), time === prevTime && !force && this._initted) return this;
                                    iteration !== prevIteration && (timeline && this._yEase && _propagateYoyoEase(timeline, isYoyo), !this.vars.repeatRefresh || isYoyo || this._lock || (this._lock = force = 1, this.render(_round(cycleDuration * iteration), !0).invalidate()._lock = 0))
                                }
                                if (!this._initted) {
                                    if (_attemptInitTween(this, time, force, suppressEvents)) return this._tTime = 0, this;
                                    if (dur !== this._dur) return this.render(totalTime, suppressEvents, force)
                                }
                                for (this._tTime = tTime, this._time = time, !this._act && this._ts && (this._act = 1, this._lazy = 0), this.ratio = ratio = (yoyoEase || this._ease)(time / dur), this._from && (this.ratio = ratio = 1 - ratio), time && !prevTime && !suppressEvents && _callback(this, "onStart"), pt = this._pt; pt;) pt.r(ratio, pt.d), pt = pt._next;
                                timeline && timeline.render(totalTime < 0 ? totalTime : !time && isYoyo ? -1e-8 : timeline._dur * ratio, suppressEvents, force) || this._startAt && (this._zTime = totalTime), this._onUpdate && !suppressEvents && (totalTime < 0 && this._startAt && this._startAt.render(totalTime, !0, force), _callback(this, "onUpdate")), this._repeat && iteration !== prevIteration && this.vars.onRepeat && !suppressEvents && this.parent && _callback(this, "onRepeat"), tTime !== this._tDur && tTime || this._tTime !== tTime || (totalTime < 0 && this._startAt && !this._onUpdate && this._startAt.render(totalTime, !0, !0), (totalTime || !dur) && (tTime === this._tDur && this._ts > 0 || !tTime && this._ts < 0) && _removeFromParent(this, 1), suppressEvents || totalTime < 0 && !prevTime || !tTime && !prevTime || (_callback(this, tTime === tDur ? "onComplete" : "onReverseComplete", !0), this._prom && !(tTime < tDur && this.timeScale() > 0) && this._prom()))
                            }
                        } else _renderZeroDurationTween(this, totalTime, suppressEvents, force);
                        return this
                    }, _proto3.targets = function targets() {
                        return this._targets
                    }, _proto3.invalidate = function invalidate() {
                        return this._pt = this._op = this._startAt = this._onUpdate = this._act = this._lazy = 0, this._ptLookup = [], this.timeline && this.timeline.invalidate(), _Animation2.prototype.invalidate.call(this)
                    }, _proto3.kill = function kill(targets, vars) {
                        if (void 0 === vars && (vars = "all"), !(targets || vars && "all" !== vars) && (this._lazy = 0, this.parent)) return _interrupt(this);
                        if (this.timeline) {
                            var tDur = this.timeline.totalDuration();
                            return this.timeline.killTweensOf(targets, vars, _overwritingTween && !0 !== _overwritingTween.vars.overwrite)._first || _interrupt(this), this.parent && tDur !== this.timeline.totalDuration() && _setDuration(this, this._dur * this.timeline._tDur / tDur), this
                        }
                        ...
                        if ((!vars || "all" === vars) && _arraysMatch(parsedTargets, killingTargets)) return _interrupt(this);
            ...
            var _setterPlain = function _setterPlain(target, property, value) {
                ...
                _renderPlain = function _renderPlain(ratio, data) {
                    return data.set(data.t, data.p, Math.round(1e4 * (data.s + data.c * ratio)) / 1e4, data)
                },
                ...
                _addPluginModifier = function _addPluginModifier(modifier, tween, target, property) {
                    for (var pt = this._pt, next; pt;) next = pt._next, pt.p === property && pt.modifier(modifier, tween, target), pt = next
                },
                _killPropTweensOf = function _killPropTweensOf(property) {
                    for (var pt = this._pt, hasNonDependentRemaining, next; pt;) next = pt._next, pt.p === property && !pt.op || pt.op === property ? _removeLinkedListItem(this, pt, "_pt") : pt.dep || (hasNonDependentRemaining = 1), pt = next;
            ...
            var _getPluginPropTween = function _getPluginPropTween(plugin, prop) {
                ...
                gsap = _gsap.registerPlugin({
                    ...
                    init: function init(target, vars, tween, index, targets) {
                        var p, pt;
                        for (p in vars)(pt = this.add(target, "setAttribute", (target.getAttribute(p) || 0) + "", vars[p], index, targets, 0, 0, p)) && (pt.op = p), this._props.push(p)
                    }
                }, {
                    name: "endArray",
                    init: function init(target, value) {
                        for (var i = value.length; i--;) this.add(target, i, target[i] || 0, value[i])
                    }
                }, _buildModifierPlugin("roundProps", _roundModifier), _buildModifierPlugin("modifiers"), _buildModifierPlugin("snap", snap)) || _gsap;
            Tween.version = Timeline.version = gsap.version = "3.3.4", _coreReady = 1, _windowExists() && _wake();
    ...
    "./node_modules/gsap/index.js":
        ...
        function(module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__), __webpack_require__.d(__webpack_exports__, "gsap", (function() {
                return gsapWithCSS
            })), __webpack_require__.d(__webpack_exports__, "default", (function() {
                return gsapWithCSS
            })), __webpack_require__.d(__webpack_exports__, "TweenMax", (function() {
            ...
            ! function(global, factory) {
                ...
                jQuery.fn = jQuery.prototype = {
                    ...
                    grep: function(elems, callback, invert) {
                        for (var callbackInverse, matches = [], i = 0, length = elems.length, callbackExpect = !invert; i < length; i++)(callbackInverse = !callback(elems[i], i)) !== callbackExpect && matches.push(elems[i]);
                        return matches
                    },
                ...
                function cloneCopyEvent(src, dest) {
                    ...
                    if (1 === dest.nodeType) {
                        if (dataPriv.hasData(src) && (events = (pdataOld = dataPriv.get(src)).events))
                ...
                function getWidthOrHeight(elem, dimension, extra) {
                    var styles = getStyles(elem),
                        boxSizingNeeded, isBorderBox = (!support.boxSizingReliable() || extra) && "border-box" === jQuery.css(elem, "boxSizing", !1, styles),
                    ...
                    jQuery.cssHooks[dimension] = {
                        ...
                        set: function(elem, value, extra) {
                            var matches, styles = getStyles(elem),
                                ...
                                boxSizingNeeded, isBorderBox = (scrollboxSizeBuggy || extra) && "border-box" === jQuery.css(elem, "boxSizing", !1, styles),
                ...
                function Animation(elem, properties, options) {
                    var result, stopped, index = 0,
                        ...
                        tick = function() {
                            if (stopped) return !1;
                            for (var currentTime = fxNow || createFxNow(), remaining = Math.max(0, animation.startTime + animation.duration - currentTime), temp, percent = 1 - (remaining / animation.duration || 0), index = 0, length = animation.tweens.length; index < length; index++) animation.tweens[index].run(percent);
                ...
                jQuery.Animation = jQuery.extend(Animation, {
                    ...
                    function() {
                        var input = document.createElement("input"),
                            select, opt = document.createElement("select").appendChild(document.createElement("option"));
    ...
    "./src/js/cursor.js":
        ...
        function(module, __webpack_exports__, __webpack_require__) {
            ...
            var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__( /*! jquery */ "./node_modules/jquery/dist/jquery.js"),
                ...
                gsap__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__( /*! gsap */ "./node_modules/gsap/index.js");
            ...
            var define = !1,
                Cursor = function() {
                    function Cursor(options) {
                        _classCallCheck(this, Cursor), this.options = jquery__WEBPACK_IMPORTED_MODULE_0___default.a.extend(!0, {
                            container: "body",
                            speed: .7,
                            ease: "expo.out",
                            visibleTimeout: 300
                        }, options), this.body = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.options.container), this.el = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div class="ht-cursor"></div>'), this.text = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div class="ht-cursor-text"></div>'), this.media = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div class="ht-cursor-media"></div>'), this.mediaBox = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div class="ht-cursor-media-box"></div>'), this.skewing = 0, this.speed = .55, this.pos = {
                            x: -500,
                            y: -500
                        }, this.vel = {
                            x: 0,
                    ...
                    return _createClass(Cursor, [{
                        ...
                        value: function bind() {
                            ...
                            this.body.on("mouseleave", (function() {
                                ...
                                _this.pos = {
                                    x: _this.stick ? _this.stick.x - .15 * (_this.stick.x - e.clientX) : e.clientX,
                                    y: _this.stick ? _this.stick.y - .15 * (_this.stick.y - e.clientY) : e.clientY
                                }, _this.update()
                        ...
                        value: function setText(text) {
                            this.text.html(text), this.el.addClass("-text")
                        }
                    }, {
                        key: "removeText",
    ...
    "./src/js/index.js":
        ...
        function(module, __webpack_exports__, __webpack_require__) {
            ...
            var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__( /*! jquery */ "./node_modules/jquery/dist/jquery.js"),
                jquery__WEBPACK_IMPORTED_MODULE_0___default = __webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__),
                cursor__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__( /*! cursor */ "./src/js/cursor.js"),
                magnetic__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__( /*! magnetic */ "./src/js/magnetic.js"),
                define = !1,
                cursor = new cursor__WEBPACK_IMPORTED_MODULE_1__.default;
            ...
            var define = !1,
                Magnetic = function() {
                    function Magnetic(el) {
                        ...
                        _classCallCheck(this, Magnetic), this.el = jquery__WEBPACK_IMPORTED_MODULE_0___default()(el), this.options = jquery__WEBPACK_IMPORTED_MODULE_0___default.a.extend(!0, {
                            y: .2,
                            x: .2,
                            s: .2,
                            rs: .7
                        }, this.el.data("magnetic") || options), this.y = 0, this.x = 0, this.width = 0, this.height = 0, this.el.data("magnetic-init") || (this.el.data("magnetic-init", !0), this.bind())
                    }
                    return _createClass(Magnetic, [{
                        key: "bind",
                        value: function bind() {
                            var _this = this;
                            this.el.on("mouseenter", (function() {
                                _this.y = _this.el.offset().top - window.pageYOffset, _this.x = _this.el.offset().left - window.pageXOffset, _this.width = _this.el.outerWidth(), _this.height = _this.el.outerHeight()
                            })), this.el.on("mousemove", (function(e) {
                                var y = (e.clientY - _this.y - _this.height / 2) * _this.options.y,
                                    x = (e.clientX - _this.x - _this.width / 2) * _this.options.x;
